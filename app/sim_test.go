...
func getSimulateFromSeedInput(tb testing.TB, w io.Writer, app *IrisApp) (
...
func invariants(app *IrisApp) []sdk.Invariant {
...
func BenchmarkFullAppSimulation(b *testing.B) {
	...
	app := NewIrisApp(logger, db, nil, true, 0)
...
func TestFullAppSimulation(t *testing.T) {
	...
	app := NewIrisApp(logger, db, nil, true, 0, fauxMerkleModeOpt)
