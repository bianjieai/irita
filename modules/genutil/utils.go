...
func InitializeNodeValidatorFiles(config *cfg.Config) (nodeID string, pv *privval.FilePV, err error) {
	...
	return nodeID, privval.LoadOrGenFilePV(pvKeyFile, pvStateFile), nil
}
