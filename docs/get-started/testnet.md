...
We use different bech32 prefixes to distinguish the mainnet and testnet, all you need to do is to run the following command in the [irishub](https://gitlab.bianjie.ai/iridas/iridas) source root before [building or installing](install.md) the iris binaries:
