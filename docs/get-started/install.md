...
The Latest IRIShub version for Mainnet is [v0.15.4](https://gitlab.bianjie.ai/iridas/iridas/releases/latest)
...
```bash
git clone --branch v0.15.4 https://gitlab.bianjie.ai/iridas/iridas
cd irishub
