<template lang="pug">
  div
    ...
    .h2 
    .p__alt 了解 IRITA 平台以及学习在 IRITA 上开发应用。
    .features
      router-link(to="./platform").features__item.features__item__light
        ...
        .features__item__text
          ...
          .features__item__text__h1 IRITA 平台介绍
          .features__item__text__p IRITA 的核心技术和架构。
      ...
      router-link(to="./quick_start").features__item.features__item__dark
        ...
        .features__item__text
          ...
          .features__item__text__p 在 IRITA 平台上构建应用
          .features__item__text__label 快速入门
    .sections__wrapper
      .h2 探索 IRITA
      .p__alt 熟悉 IRITA 平台的各种概念和功能
      .sections
    ...
    .h2 IRITA 开发参考
    .p__alt SDK 以及 REST-HUB API 参考文档
    .stack
