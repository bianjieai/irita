...
require (
	...
	github.com/bianjieai/iritamod v0.0.0-20201126122620-0d2957453ed1
...
replace (
	github.com/cosmos/cosmos-sdk => github.com/bianjieai/cosmos-sdk v0.34.4-0.20201126062143-83b73b6bdce1
