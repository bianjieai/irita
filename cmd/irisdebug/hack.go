...
import (
	...
	iris "gitlab.bianjie.ai/iridas/iridas/app"
)
...
func runHackCmd(cmd *cobra.Command, args []string) error {
	...
	db, err := sdk.NewLevelDB("iris", dataDir)
	if err != nil {
		fmt.Println(err)
		os.Exit(1)
	}
	app, keyMain, keyStaking, stakingKeeper := iris.NewIrisAppUNSAFE(
